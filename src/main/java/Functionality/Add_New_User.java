...
public class Add_New_User {
    ...
    public void Populate_First_Name(String fn) {
    ...
    public void Populate_Last_Name(String ln) {
    ...
    public void Populate_UserName(String un) {
    ...
    public void Populate_Password(String pn) {
    ...
    public void Verify_Data_Saved(String saved_fn,String saved_ln) throws InterruptedException {
